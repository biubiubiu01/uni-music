...
var store = new _vuex.default.Store({
  state: {
    ...
    playing: false, //播放状态
    userInfo: (0, _cache.getCache)('USER_INFO'),
    cookie: (0, _cache.getCache)('COOKIE'),
    historyList: (0, _cache.getCache)('HISTORY') || [],
    playList: (0, _cache.getCache)('PLAY_LIST') || [] },
  ...
  mutations: {
    ...
    //从对应歌曲列表中删除 当前歌曲
    REMOVE_MUSIC_PLAY: function REMOVE_MUSIC_PLAY(state, list) {
...
/* WEBPACK VAR INJECTION */(function(uni) {// const audio = uni.createInnerAudioContext();
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getUserHistory = exports.getUserInfo = exports.likeData = exports.likeMusic = exports.getLoginStatus = exports.login = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request */ 16));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var likeMusic = function likeMusic(params) {
  return _request.default.get('/like', params);
};

/**
    *  喜欢音乐列表
    */exports.likeMusic = likeMusic;
var likeData = function likeData(params) {
  return _request.default.get('/likelist', params);
};
...
var getUserInfo = function getUserInfo(params) {
  return _request.default.get('/user/playlist', params);
};

/**
    *  获取用户最近播放记录
    */exports.getUserInfo = getUserInfo;
var getUserHistory = function getUserHistory(params) {
  return _request.default.get('/user/record', params);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _cache = __webpack_require__(/*! @/utils/cache.js */ 14);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var home = __webpack_require__(/*! ./modules/home */ 18);
var user = __webpack_require__(/*! ./modules/user */ 15);
var search = __webpack_require__(/*! ./modules/search */ 19);
var playList = __webpack_require__(/*! ./modules/playList */ 20);
var qq = __webpack_require__(/*! ./modules/qq */ 21);
var songList = __webpack_require__(/*! ./modules/songList */ 23);
var rankList = __webpack_require__(/*! ./modules/rankList */ 24);
var singer = __webpack_require__(/*! ./modules/singer */ 25);var _default = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({},
...
songList),
rankList),
singer);exports.default = _default;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.getSelectionData = exports.getHotSingerList = exports.getDayRecommendMusicList = exports.getDayRecommendList = exports.getNewSongList = exports.getRecommendList = exports.getBanner = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request */ 16));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var getRecommendList = function getRecommendList(params) {
  return _request.default.post('/personalized', params);
};
...
var getSelectionData = function getSelectionData() {
  return _request.default.get('/top/playlist', {
    limit: 10,
    order: 'hot' });
...
/**
    *  热门搜索 详细
    *  @return {Array}
    */exports.getDefaultSearch = getDefaultSearch;
var getHotDetailSearch = function getHotDetailSearch(params) {
  return _request.default.get('/search/hot/detail', params);
};
...
var getSuggestList = function getSuggestList(params) {
  ...
  return _request.default.get('/search/suggest', data);
};
...
var getSearchList = function getSearchList(params) {
  return _request.default.get('/cloudsearch', params);
};
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getPlayDetail = exports.getPlayListData = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request */ 16));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/**
                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                     *  @return {Array}
                                                                                                                                                                                                                                                                                                     */
var getPlayListData = function getPlayListData(params) {
  return _request.default.get('/playlist/detail', params);
};
...
var getPlayDetail = function getPlayDetail(params) {
  return _request.default.get('/song/detail', params);
};exports.getPlayDetail = getPlayDetail;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.searchQQMusicLyric = exports.searchQQMusicUrl = exports.searchQQMusic = void 0;var _qqRequest = _interopRequireDefault(__webpack_require__(/*! @/utils/qqRequest */ 22));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/**
                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                       *  @return {Array}
                                                                                                                                                                                                                                                                                                                                       */
var searchQQMusic = function searchQQMusic(params) {
  return _qqRequest.default.get('/search', params);
};
...
/**
    ...
    *  @param  {Number}  key
    *  @return {Array}
    */exports.searchQQMusic = searchQQMusic;
var searchQQMusicUrl = function searchQQMusicUrl(params) {
  return _qqRequest.default.get('/song/urls', params);
};
...
/**
    ...
    *  @param  {Number}  key
    *  @return {Array}
    */exports.searchQQMusicUrl = searchQQMusicUrl;
var searchQQMusicLyric = function searchQQMusicLyric(params) {
  return _qqRequest.default.get('/lyric', params);
};exports.searchQQMusicLyric = searchQQMusicLyric;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var baseURL = 'https://api.qq.jsososo.com';
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getSongList = exports.getSongTagList = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request */ 16));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

/**
                                                                                                                                                                                                                                                                                                  *  歌单 获取歌单分类标签
                                                                                                                                                                                                                                                                                                  *  @return {Array}
                                                                                                                                                                                                                                                                                                  */
var getSongTagList = function getSongTagList(params) {
  return _request.default.get('/playlist/catlist', params);
};

/**
    *  歌单  所有歌单
    *  @return {Array}
    */exports.getSongTagList = getSongTagList;
var getSongList = function getSongList(params) {
  return _request.default.get('/top/playlist', params);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getRankList = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request */ 16));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var getRankList = function getRankList() {
  return _request.default.get('/toplist/detail');
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getSingerAllMusic = exports.getSingerInfo = exports.getSingerList = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request */ 16));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var getSingerList = function getSingerList() {
  return _request.default.get('/toplist/artist');
};
...
var getSingerInfo = function getSingerInfo(params) {
  return _request.default.get('/artists', params);
};
...
var getSingerAllMusic = function getSingerAllMusic(params) {
  return _request.default.get('/artist/songs', params);
};exports.getSingerAllMusic = getSingerAllMusic;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.debounce = debounce;exports.filterPlayCount = filterPlayCount;exports.getImage = getImage;exports.getName = getName; /**
                                                                                                                                                                                                         * 函数防抖
                                                                                                                                                                                                         * @param {Function} func
                                                                                                                                                                                                         * @param {number} delay
                                                                                                                                                                                                         * @return {*}
...
/**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 */
function getGroupByPinyin(arr) {var key = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'name';
  if (!arr) return;

  // 获取A-Z字母数组
  var keys = _toConsumableArray(Array(26).keys()).map(function (i) {return String.fromCharCode(i + 65);});

  arr = arr.map(function (n) {return _objectSpread(_objectSpread({},
    n), {}, {
      py: _toPinyin.default.chineseToInitials(
      _toPinyin.default.chineseToPinYin(n[key].substr(0, 1))) });});



  var group = [];var _iterator = _createForOfIteratorHelper(
  keys),_step;try {for (_iterator.s(); !(_step = _iterator.n()).done;) {var i = _step.value;
      // 新数组一级结构，可自行修改
      var item = {
        name: i,
        value: [] };var _iterator2 = _createForOfIteratorHelper(

      arr),_step2;try {for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {var j = _step2.value;
          if (j.py === i) {
            item.value.push(j);
          }
        }} catch (err) {_iterator2.e(err);} finally {_iterator2.f();}
      if (item.value.length > 0) {
        item.value.sort(function (a, b) {return a[key].localeCompare(b[key]);});
        group.push(item);
      }
...
ToPinyin = /*#__PURE__*/function () {
  ...
  function ToPinyin() {_classCallCheck(this, ToPinyin);
    ...
    value: function chineseToInitials(word) {
      var SX = '';
    ...
    // 转拼音
  }, { key: "chineseToPinYin", value: function chineseToPinYin(l1) {
      var l2 = l1.length;
      var I1 = '';
      var reg = new RegExp('[a-zA-Z0-9]');
      for (var i = 0; i < l2; i++) {
        var val = l1.substr(i, 1);
        var name = this.arraySearch(val, _pinyin.default);
        if (reg.test(val)) {
          I1 += val;
        } else if (name !== false) {
          I1 += name;
      ...
      return I1;
    } }, { key: "arraySearch", value: function arraySearch(

    l1, l2) {
      for (var name in _pinyin.default) {
        if (_pinyin.default[name].indexOf(l1) !== -1) {
          return this.ucfirst(name);
        }
      }
      return false;
    } }, { key: "ucfirst", value: function ucfirst(
    ...
    } }], [{ key: "getInstance", value: function getInstance() {if (!this.instance) {this.instance = new ToPinyin();}return this.instance;} }]);return ToPinyin;}();_defineProperty(ToPinyin, "instance", void 0);



var toPinyin = ToPinyin.getInstance();var _default =
toPinyin;exports.default = _default;
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  'nou': "\u8028",
  'fou': "\u7F36",
  'bia': "\u9ADF" };exports.default = _default;
